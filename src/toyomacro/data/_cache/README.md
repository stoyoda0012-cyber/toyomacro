...
| `trzh2018_haxpes.json` | Trzhaskovskaya 2018 xlsx (not distributed) | HAXPES σ/β/γ/δ, Z=1–100, 1.5–10 keV |
| `trzh2019_inner.json` | Trzhaskovskaya 2019 xlsx (not distributed) | Inner-shell σ/β/γ/δ, Z=13–100 |
