...
python examples/05_width_identifiability_map.py
```
...
| `05_width_identifiability_map.py` | How well a spectrum can tell the Gaussian from the Lorentzian width, mapped over window, shape and background — separating the degenerate σ coordinate from real loss of information. Model bounds, not a fit — details in [`docs/design/voigt-width-identifiability.md`](../docs/design/voigt-width-identifiability.md) | `scan_identifiability`, `ScanGrid` (experimental) |
