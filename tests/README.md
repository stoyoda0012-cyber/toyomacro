...
This suite has **2,224 automated tests** across **84 files**, in two
locations:

| Location | Scope | Files | Tests |
|---|---|--:|--:|
| `tests/` | Library body — lineshapes, backgrounds, templates, I/O, quantification, meta | 47 | 1,243 |
...
- **Contract / regression** (1,792 tests, 80%) — guarantee the library
...
### Lineshape & background — physics core (238)
| Tests | File | Guards |
|--:|---|---|
