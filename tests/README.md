...
This suite has **2,314 automated tests** across **86 files**, in two
locations:

| Location | Scope | Files | Tests |
|---|---|--:|--:|
| `tests/` | Library body — lineshapes, backgrounds, templates, I/O, quantification, meta | 48 | 1,264 |
...
- **Contract / regression** (1,882 tests, 81%) — guarantee the library
...
## Library body — `tests/` (1,264)

### Claim guards — noise model, versions, backends, comparisons (86)
| Tests | File | Guards |
|--:|---|---|
...
| 15 | `test_benchmarks_doc_citations.py` | Every figure `docs/BENCHMARKS.md` attributes to a committed record is in that record, and an unattributed measurement says "no record" |
