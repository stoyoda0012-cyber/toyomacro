...
This suite has **2,061 automated tests** across **81 files**, in two
locations:

| Location | Scope | Files | Tests |
|---|---|--:|--:|
| `tests/` | Library body — lineshapes, backgrounds, templates, I/O, quantification, meta | 44 | 1,082 |
| `src/toyomacro/voigtfit/tests/` | VoigtFit engine — solvers, encoders, information theory | 37 | 979 |
...
- **Contract / regression** (1,629 tests, 79%) — guarantee the library
...
## VoigtFit engine — `src/toyomacro/voigtfit/tests/` (979)
...
| Tests | File | Guards |
|--:|---|---|
| 36 | `test_memory.py` | Memory detection, peak RSS, optimal chunk size, dict3d cache size |
