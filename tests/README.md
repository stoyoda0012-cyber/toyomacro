...
This suite has **2,129 automated tests** across **82 files**, in two
locations:

| Location | Scope | Files | Tests |
|---|---|--:|--:|
| `tests/` | Library body — lineshapes, backgrounds, templates, I/O, quantification, meta | 45 | 1,152 |
...
- **Contract / regression** (1,697 tests, 80%) — guarantee the library
...
### Lineshape & background — physics core (160)
| Tests | File | Guards |
|--:|---|---|
