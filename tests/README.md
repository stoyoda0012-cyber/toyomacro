...
This suite has **2,330 automated tests** across **86 files**, in two
locations:

| Location | Scope | Files | Tests |
|---|---|--:|--:|
| `tests/` | Library body — lineshapes, backgrounds, templates, I/O, quantification, meta | 48 | 1,271 |
...
- **Contract / regression** (1,898 tests, 81%) — guarantee the library
...
## Library body — `tests/` (1,271)

### Claim guards — noise model, versions, backends, comparisons (93)
| Tests | File | Guards |
|--:|---|---|
...
| 22 | `test_benchmarks_doc_citations.py` | Every figure `docs/BENCHMARKS.md` attributes to a committed record is in that record, and an unattributed measurement says "no record" |
