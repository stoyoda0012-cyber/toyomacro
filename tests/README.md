...
This suite has **2,199 automated tests** across **84 files**, in two
locations:

| Location | Scope | Files | Tests |
|---|---|--:|--:|
| `tests/` | Library body — lineshapes, backgrounds, templates, I/O, quantification, meta | 47 | 1,218 |
...
- **Contract / regression** (1,767 tests, 80%) — guarantee the library
...
### Lineshape & background — physics core (213)
| Tests | File | Guards |
|--:|---|---|
