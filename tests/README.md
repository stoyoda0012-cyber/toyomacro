...
## Library body — `tests/` (1,260)

### Claim guards — noise model, versions, backends, comparisons (82)
| Tests | File | Guards |
|--:|---|---|
...
| 11 | `test_benchmarks_doc_citations.py` | Every figure `docs/BENCHMARKS.md` attributes to a committed record is in that record, and an unattributed measurement says "no record" |
