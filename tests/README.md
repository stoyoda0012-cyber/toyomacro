...
This suite has **2,360 automated tests** across **86 files**, in two
locations:
...
- **Contract / regression** (1,928 tests, 82%) — guarantee the library
...
marker; `pytest -m "not perf"` drops them and leaves 2,348. Marking
