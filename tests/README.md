...
This suite has **2,219 automated tests** across **84 files**, in two
locations:

| Location | Scope | Files | Tests |
|---|---|--:|--:|
| `tests/` | Library body — lineshapes, backgrounds, templates, I/O, quantification, meta | 47 | 1,238 |
...
- **Contract / regression** (1,787 tests, 80%) — guarantee the library
